"""
Django settings for nutritional_values_calculator project.
...
ROOT_URLCONF = 'nutritional_values_calculator.urls'
...
WSGI_APPLICATION = 'nutritional_values_calculator.wsgi.application'
